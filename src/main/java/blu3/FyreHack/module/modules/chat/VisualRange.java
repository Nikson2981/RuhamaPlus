package blu3.FyreHack.module.modules.chat;
...
public class VisualRange extends Module {
    public VisualRange(){super("VisualRange", 0, Category.CHAT,"Alerts you when someone enters your render distance", null);}
            ...
            for (Entity e : players) {
                if (e instanceof EntityPlayer && !e.getName().equalsIgnoreCase(mc.player.getName())) {
                    if (!knownPlayers.contains(e)) {
                        knownPlayers.add(e);
                        FyreLogger.log(e.getName() + " entered visual range.");
                    }
                }
            }
        } catch(Exception e){}
            ...
            for (Entity e : knownPlayers) {
                if (e instanceof EntityPlayer && !e.getName().equalsIgnoreCase(mc.player.getName())) {
                    if (!players.contains(e)) {
                        ...
                        FyreLogger.log(e.getName() + " left visual range.");
                    }
                }
            }
        } catch(Exception e){}
