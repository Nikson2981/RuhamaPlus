...
public class ModuleWindowDark extends ModuleWindow
{
    ...
    public void draw(int mX, int mY, int leng)
    {
        ...
        //GuiScreen.drawRect(this.posX, this.posY - 10, this.posX + 1, y2, 87);
        //GuiScreen.drawRect(this.posX, y2, x2, y2 + 1, Rainbow.getInt());
        //GuiScreen.drawRect(x2, this.posY - 10, this.posX, this.posY - 11, 87);
        //GuiScreen.drawRect(x2, y2, x2 + 1, this.posY - 11, 87);
