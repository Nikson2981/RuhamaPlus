...
public class Surround extends Module
{
    public Surround()
    {
        super("Surround", 0, Category.COMBAT, "Build obsidian around you to protect you from beds", Arrays.asList(new SettingMode("Mode: ", "1x1", "2x2", "Smart"), new SettingToggle(true, "Switch Back"), new SettingToggle(false, "2 High"), new SettingToggle(true, "2b Bypass"), new SettingToggle(true, "Center ")));
    }
