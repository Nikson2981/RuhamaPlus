...
public class CrystalAuraECME extends Module
{
    ...
    {
        super("CrystalAuraECME", 0, Category.COMBAT, "1 block CA for endcrystal.me", settings);
    }
    ...
    public void onEnable()
    {
        ...
        {
            ClientChat.log("AutoCrystalECME: " + TextFormatting.GREEN + "ON!");
        }
    }
    ...
    public void onDisable()
    {
        if (this.getSettings().get(6).toToggle().state)
        {
            ClientChat.log("AutoCrystalECME: " + TextFormatting.RED + "OFF!");
        }
