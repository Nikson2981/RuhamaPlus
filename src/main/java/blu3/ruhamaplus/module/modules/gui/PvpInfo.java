...
public class PvpInfo extends Module {
    ...
    public void onOverlay(){
        ...
        if (this.getSettings().get(2).toToggle().state) this.getWindows().get(2).addText(new AdvancedText("Totems: " + t, true, color));
        if (this.getSettings().get(3).toToggle().state) this.getWindows().get(3).addText(new AdvancedText("Beds: " + b, true, color));
